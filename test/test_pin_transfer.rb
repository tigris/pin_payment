...
class TestPinTransfer < MiniTest::Unit::TestCase
  ...
  def test_fetch_all_transfers
    FakeWeb.register_uri(:get, 'https://test-api.pinpayments.com/1/transfers', body: fixtures['responses']['transfer']['all'])
  ...
  def test_find_transfer
    transfer = created_transfer
    FakeWeb.register_uri(:get, "https://test-api.pinpayments.com/1/transfers/#{transfer.token}", body: fixtures['responses']['transfer']['created'])
  ...
  def test_line_items
    transfer = created_transfer
    FakeWeb.register_uri(:get, "https://test-api.pinpayments.com/1/transfers/#{transfer.token}/line_items", body: fixtures['responses']['line_item']['all'])
